        ...
        children: [
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: const Text(
                  'Home',
                  style:
                      TextStyle(fontSize: 13, color: AppColors.cardTextColor),
                ),
              ),
              const SizedBox(
                width: 15,
          ...
          Row(
            children: [
                    ...
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          image: DecorationImage(
                              image: AssetImage('lib/assets/images/en.jpeg'))),
                    ),
                    const Text(
                      'En',
                      style: TextStyle(
              ...
              const Text(
                'Sign Up',
                style: TextStyle(fontSize: 13, color: AppColors.cardTextColor),
              ),
              SizedBox(
                width: MediaQuery.of(context).size.width * 0.01,
              ),
