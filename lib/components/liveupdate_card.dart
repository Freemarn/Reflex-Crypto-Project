...
class MiniCards extends StatelessWidget {
  ...
  const MiniCards({super.key, required this.imageUrl, required this.imageText, required this.abbr, required this.currentPrice, required this.changePrice, required this.vol, required this.changePriceColor, required this.borderColor});
