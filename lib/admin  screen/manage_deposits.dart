                          ...
                          DataTable(
                            ...
                            rows: [
                              DataRow(cells: [
                                ...
                                child: const Center (child: Text('View', style: TextStyle(fontSize: 10, color: Colors.white),)), 
                              ),
                              ...
                              Container(
                                ...
                                child: const Center (child: Text('Delete', style: TextStyle(fontSize: 10, color: Colors.white),)), 
                              ),
                                    ],
                                  )
                                )
